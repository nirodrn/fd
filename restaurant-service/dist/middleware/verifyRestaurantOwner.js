...
exports.verifyRestaurantOwner = void 0;
var _jsonwebtoken = _interopRequireDefault(require("jsonwebtoken"));
var _Restaurant = _interopRequireDefault(require("../models/Restaurant.js"));
var _Menu = _interopRequireDefault(require("../models/Menu.js"));
...
var verifyRestaurantOwner = exports.verifyRestaurantOwner = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$headers$authoriz, token, userId, user, restaurantId, menuItem, restaurant;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          return _context.abrupt("return", res.status(403).json({
            message: "Access denied. Only restaurant admins can manage menu items."
          }));
        case 12:
        ...
        case 16:
          ...
          _context.next = 19;
          return _Menu["default"].findById(req.params.id);
        case 19:
        ...
        case 26:
          _context.next = 28;
          return _Restaurant["default"].findById(restaurantId);
        case 28:
        ...
        case 31:
          ...
          return _context.abrupt("return", res.status(403).json({
            message: "Unauthorized. You can only manage menu items for your own restaurant."
          }));
        case 33:
  ...
  return function verifyRestaurantOwner(_x, _x2, _x3) {
