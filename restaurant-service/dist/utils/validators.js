...
exports.validateRole = exports.validateRegistration = exports.validatePhone = exports.validatePassword = exports.validateName = exports.validateNIC = exports.validateLocation = exports.validateEmail = exports.validateAddress = void 0;
...
var validateName = exports.validateName = function validateName(name) {
  if (!name || name.length < validationPatterns.name.min || name.length > validationPatterns.name.max) {
    return "Name must be between ".concat(validationPatterns.name.min, " and ").concat(validationPatterns.name.max, " characters.");
  }
  return null;
};
...
var validateAddress = exports.validateAddress = function validateAddress(address) {
  if (!address || address.length > validationPatterns.address.maxLength) {
    return "Address must be less than ".concat(validationPatterns.address.maxLength, " characters.");
  }
  return null;
};
...
var validateNIC = exports.validateNIC = function validateNIC(nic) {
  if (!nic || nic.length > validationPatterns.nic.maxLength) {
    return "NIC must be no more than ".concat(validationPatterns.nic.maxLength, " characters.");
  }
  return null;
};

// Validate role (assuming it's always a string like 'restaurant_admin')
var validateRole = exports.validateRole = function validateRole(role) {
...
var validateLocation = exports.validateLocation = function validateLocation(location) {
  if (!location || _typeof(location) !== 'object' || !location.latitude || !location.longitude) {
...
var validateRegistration = exports.validateRegistration = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var errors, nameError, emailError, passwordError, phoneError, addressError, nicError, roleError, locationError;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          errors = {}; // Validate each field and add any errors
          ...
          nicError = validateNIC(data.nic);
          if (nicError) errors.nic = nicError;
          roleError = validateRole(data.role);
          if (roleError) errors.role = roleError;
          locationError = validateLocation(data.location);
