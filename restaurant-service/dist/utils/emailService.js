...
var transporter = _nodemailer["default"].createTransport({
  service: "Gmail",
  auth: {
    user: _index["default"].EMAIL_USER,
    pass: _index["default"].EMAIL_PASS
  }
});
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(to, subject, text) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          html = _args.length > 3 && _args[3] !== undefined ? _args[3] : null;
          _context.prev = 1;
          mailOptions = _objectSpread({
            from: "\"Food App\" <".concat(_index["default"].EMAIL_USER, ">"),
            to: to,
            subject: subject,
            text: text
          }, html && {
        ...
        case 5:
          info = _context.sent;
          console.log("Email sent to ".concat(to, ": ").concat(info.response));
          return _context.abrupt("return", info);
        case 10:
          _context.prev = 10;
          _context.t0 = _context["catch"](1);
          console.error("Failed to send email to ".concat(to, ":"), _context.t0.message);
